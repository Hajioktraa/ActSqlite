...
public class DisplayMhs extends AppCompatActivity {
    ...
    private com.example.activitysqlite.DBHelper mydb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_mhs2);
        ...
        mydb = new com.example.activitysqlite.DBHelper(this);
        ...
        if (extras != null) {
            ...
            if (Value > 0) {
                ...
                String no = rs.getString(rs.getColumnIndex(com.example.activitysqlite.DBHelper.MHS_COLUMN_NIM));
                String nam = rs.getString(rs.getColumnIndex(com.example.activitysqlite.DBHelper.MHS_COLUMN_NAMA));
                String phon = rs.getString(rs.getColumnIndex(com.example.activitysqlite.DBHelper.MHS_COLUMN_PHONE));
                if (!rs.isClosed()) {
                    rs.close();
                }
